export function ChatNotices() {
  return (
    <div className="hidden border-t border-gray-200/70 bg-white/70 px-4 py-2 text-[11px] text-gray-500 dark:border-gray-700/70 dark:bg-gray-800/70 dark:text-gray-400 min-[1168px]:block">
